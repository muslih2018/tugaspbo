...
public class Controller implements Initializable {
    ...
    ObservableList<Product> observableList=FXCollections.observableArrayList(
        new Product("muslih","12 APRIL 2080","08.00 WIB-09.00 WIB","081342575803","Rp.150.000")
...
public void buttonAdd(ActionEvent actionEvent) {
        ...
        Product product=new Product(textfieldName.getText(),(textfieldPrice.getText()),(textfieldQuantity.getText()),(textfieldQuantity1.getText()),("Rp."+textfieldQuantity2.getText()+"50.000"));
